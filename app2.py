...
def app():
    ...
    st.image("./ai.png")
    #st.title("EXPLAIN THIS ECHO!")
    #st.header("Want to know how your heart is doing? An echocardiogram can tell you that.")
    
    #st.write("---")

    #st.write("An echocardiogram is an ultrasound of the heart. It can tell you how strong your heart is, how your valves are functioning and sometimes can also tell you about a possible blocked artery. However, the medical jargon in an echocardiogram report can make it hard to understand. We set out to simplify this using artificial intelligence)")
