...
defaultPrompt = """My second grader asked me what this passage means:
...
Output: 
Normal pumping function of the left and right side of the heart. Heart valves are normal
...
Output: 
Heart is enlarged with reduced pumping if the right as well as left side of the heart. Mitral valve is severely leaky. Large artery coming out of the heart (aorta) is enlarged. Aortic valve is moderately leaky. These findings are worse compared to an earlier study
